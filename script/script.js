const loadLessons = ()=>{
 ...
 const displayWordDetails = (word) =>{
       ...
       detailsBox.innerHTML=`
                     <div class="">
               <h2 class="text-2xl font-bold">${word.word} ( <i class="fa-solid fa-microphone-lines"></i> ${word.pronunciation}    :ইগার)</h2>
            </div>
            <div class="">
...
document.getElementById('btn-search').addEventListener('click', ()=>{
  ...
  .then(data =>{
   ...
   const filterWords =allWords.filter(word => word.word.toLowerCase().includes(searchVlaue));
